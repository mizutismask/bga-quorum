...
declare class CardStock<T> {
	 ...
	 */
	setLastPlayedCards(cards: T[] | null, color?: string): void
}
...
declare class ManualPositionStock<T> extends CardStock<T> {
	...
	constructor(
		...
		updateDisplay: (element: HTMLElement, cards: T[], lastCard: T, stock: ManualPositionStock<T>) => any
	)
	/**
	 * Add a card to the stock.
	 *
