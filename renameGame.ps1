...
Get-ChildItem $Directory -File -Recurse -exclude *.png, *.jpg, *.ps1 | ForEach-Object { (Get-Content $_.FullName) | ForEach-Object { $_ -creplace [regex]::Escape('YourGameName'), 'Quorum' } | Set-Content $_.FullName }
